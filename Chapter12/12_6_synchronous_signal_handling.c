/*
	Example:
	$gcc -Wall 12_6_synchronous_signal_handling.c  -lpthread ../lib/error.c -o 12_6_synchronous_signal_handling                     
	$./12_6_synchronous_signal_handling 
	^C
	interrupt
	^C
	interrupt
	...
	Analyse:
	Note that we block SIGINT and SIGQUIT in the beginning of the main thread. When we creat e the thread to 
